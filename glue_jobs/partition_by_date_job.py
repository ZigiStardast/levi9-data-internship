'''
Load and Partition Data from S3 Files - Trello task
Za weather, pollution i sensor mi je ista skripta, jedina razlika 
je partition kolona kod sensor - time_nano.
'''
